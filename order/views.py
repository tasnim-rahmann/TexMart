...
def initiate_payment(request):
    ...
    settings = { 'store_id': 'mymar689e0e162ad66', 'store_pass': 'mymar689e0e162ad66@ssl', 'issandbox': True }
    ...
    return Response({"error": "Payment initiation faild"}, status=status.HTTP_400_BAD_REQUEST)
...
def payment_success(request):
    ...
    order.save()
    return redirect(f"{main_settings.FRONTEND_URL}/dashboard/payment/orders/")
